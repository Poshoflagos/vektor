...
import { PATH_METADATA } from "../data/paths"
...
function PromptGenerator({ userProfile, recommendedPaths, guideType, setCurrentScreen }) {
  ...
  useEffect(() => {
    ...
    const bestPathId = paths.best?.[0] || paths.best
    const pathMeta = PATH_METADATA[bestPathId]
    const topPath = {
      id: bestPathId,
      name: pathMeta?.name || bestPathId,
      ...pathMeta
    }

    const generated = buildPrompt(profile, topPath, guide || "free")
    setPrompt(generated)
  }, [])
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>
          This prompt was built from your profile. Copy it and paste it into ChatGPT or Claude.
        </p>
